...
public class JmsPoolConnectionProxy implements Connection, TopicConnection, QueueConnection, ExceptionListener {
    ...
    @Override
    public JmsPoolSessionProxy createSession() throws JMSException {
        return createSession(false, Session.AUTO_ACKNOWLEDGE);
    }

    @Override
    public JmsPoolSessionProxy createSession(int sessionMode) throws JMSException {
        return createSession(false, sessionMode);
    }

    @Override
    public JmsPoolSessionProxy createTopicSession(boolean transacted, int acknowledgeMode) throws JMSException {
        return createSession(transacted, acknowledgeMode);
    }

    @Override
    public JmsPoolSessionProxy createQueueSession(boolean transacted, int acknowledgeMode) throws JMSException {
        return createSession(transacted, acknowledgeMode);
    }
            ...
            new KeyedPooledObjectFactory<JmsPoolSessionKey, JmsPoolSessionProxy>() {
                ...
                public PooledObject<JmsPoolSessionProxy> makeObject(JmsPoolSessionKey sessionKey) throws Exception {
                    return new DefaultPooledObject<JmsPoolSessionProxy>(
                        new JmsPoolSessionProxy(JmsPoolConnectionProxy.this, sessionKey, makeSession(sessionKey), sessionPool));
                }
